...
class User_Node(Node):
    def __init__(self):
        ...
        self.subscriber_ = self.create_subscription(String, 'clarifying_question',
                                                    self.get_question_and_respond, 10)
        self.subscriber_ = self.create_subscription(String, 'target',
                                                    self.reset_for_next_request, 10)
